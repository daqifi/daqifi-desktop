...
| Digital-output tile drive switch (one per DO tile; TogglePattern reads and drives the commanded state) | `OutputDriveToggle` | `View/Prototype/ChannelsPanePrototype.xaml` |
