  ...
  public static partial class WiFiDAQOutMessage {
    ...
    static WiFiDAQOutMessage() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChdXaUZpREFRT3V0TWVzc2FnZS5wcm90byL6AwoRV2lGaURBUU91dE1lc3Nh", 
            ...
            "CWRhY19ieXRlcxgZIAEoDRIRCglkZXZpY2VfcG4YGiABKAkSEwoLZGV2aWNl", 
          "X3BvcnQYGyABKA0SGgoSd2lmaV9zZWN1cml0eV9tb2RlGBwgASgN"));
      pbd::FileDescriptor.InternalDescriptorAssigner assigner = delegate(pbd::FileDescriptor root) {
        ...
        internal__static_WiFiDAQOutMessage__FieldAccessorTable = 
            new pb::FieldAccess.FieldAccessorTable<global::WiFiDAQOutMessage, global::WiFiDAQOutMessage.Builder>(internal__static_WiFiDAQOutMessage__Descriptor,
                new string[] { "MsgSeq", "AnalogInDataI", "AnalogInDataB", "DigitalData", "DeviceStatus", "BatLevel", "PwrStatus", "BoardTemp", "AnalogOutData", "IpAddr", "HostName", "MacAddr", "Ssid", "DigitalPortDir", "AnalogPortRse", "AnalogPortEnabled", "AnalogPortRange", "AdcBytes", "DacBytes", "DevicePn", "DevicePort", "WifiSecurityMode", });
        return null;
      };
...
public sealed partial class WiFiDAQOutMessage : pb::GeneratedMessage<WiFiDAQOutMessage, WiFiDAQOutMessage.Builder> {
  ...
  private static readonly string[] _wiFiDAQOutMessageFieldNames = new string[] { "adc_bytes", "analog_in_data_b", "analog_in_data_i", "analog_out_data", "analog_port_enabled", "analog_port_range", "analog_port_rse", "bat_level", "board_temp", "dac_bytes", "device_pn", "device_port", "device_status", "digital_data", "digital_port_dir", "host_name", "ip_addr", "mac_addr", "msg_seq", "pwr_status", "ssid", "wifi_security_mode" };
  private static readonly uint[] _wiFiDAQOutMessageFieldTags = new uint[] { 192, 26, 18, 74, 178, 186, 170, 48, 64, 200, 210, 216, 40, 34, 162, 138, 130, 146, 8, 56, 154, 224 };
  ...
  public const int DevicePnFieldNumber = 26;
  ...
  public const int DevicePortFieldNumber = 27;
  ...
  public const int WifiSecurityModeFieldNumber = 28;
  ...
  public override void WriteTo(pb::ICodedOutputStream output) {
    ...
    if (hasMsgSeq) {
      output.WriteUInt32(1, field_names[18], MsgSeq);
    }
    ...
    if (hasDigitalData) {
      output.WriteBytes(4, field_names[13], DigitalData);
    }
    if (hasDeviceStatus) {
      output.WriteUInt32(5, field_names[12], DeviceStatus);
    }
    if (hasBatLevel) {
      output.WriteUInt32(6, field_names[7], BatLevel);
    }
    if (hasPwrStatus) {
      output.WriteUInt32(7, field_names[19], PwrStatus);
    }
    if (hasBoardTemp) {
    ...
    if (ipAddr_.Count > 0) {
      output.WriteBytesArray(16, field_names[16], ipAddr_);
    }
    if (hasHostName) {
      output.WriteString(17, field_names[15], HostName);
    }
    if (macAddr_.Count > 0) {
      output.WriteBytesArray(18, field_names[17], macAddr_);
    }
    if (hasSsid) {
      output.WriteString(19, field_names[20], Ssid);
    }
    if (hasDigitalPortDir) {
      output.WriteBytes(20, field_names[14], DigitalPortDir);
    }
    if (hasAnalogPortRse) {
    ...
    if (hasDevicePn) {
      output.WriteString(26, field_names[10], DevicePn);
    }
    if (hasDevicePort) {
      output.WriteUInt32(27, field_names[11], DevicePort);
    }
    if (hasWifiSecurityMode) {
      output.WriteUInt32(28, field_names[21], WifiSecurityMode);
    }
  ...
  private int CalcSerializedSize() {
    ...
    if (hasDevicePn) {
      size += pb::CodedOutputStream.ComputeStringSize(26, DevicePn);
    }
    if (hasDevicePort) {
      size += pb::CodedOutputStream.ComputeUInt32Size(27, DevicePort);
    }
    if (hasWifiSecurityMode) {
      size += pb::CodedOutputStream.ComputeUInt32Size(28, WifiSecurityMode);
    }
